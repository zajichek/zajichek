...
This estimator is referred to as the _average treatment effect in the overlap population (ATO)_ (see [paper](https://pubmed.ncbi.nlm.nih.gov/30189042/) for details). It's described this way because the contribution in the weighted-average comes most prominently from subjects whose overlap weight, $\hat{OW_i}$, is closest to 0.5 (i.e., the probability of receiving the opposite treatment). Hence, these are subjects who have the most overlap in characteristics with the opposing treatment group.
