...
* [Constructing the Map](#mapoverview)
  1. [Building the dataset](#usecasedataset)
  2. [Create the base layer](#baselayer)
...
We'll do a little clean-up on the cohort indicators for cleaner names and nicer presentation.
