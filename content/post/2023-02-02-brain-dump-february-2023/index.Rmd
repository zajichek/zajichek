---
title: 'Brain Dump: February 2023'
author: Alex Zajichek
date: '2023-02-02'
slug: brain-dump-february-2023
categories: []
tags: []
subtitle: ''
summary: ''
authors: []
lastmod: '2023-02-02T11:10:15-06:00'
featured: no
image:
  caption: ''
  focal_point: ''
...
* [Nesting with `tidyr`](#nesting)

# Nesting with `tidyr` {#nesting}

_2/2/2023_

I really love the elegance of the `nest` functionality with the `tidyr` package. It really allows you to abstract the meaning of a data frame to not just contain rectangular data with scalars, but rather a generalization that has rectangular data of _objects_. The most intriguing part of it to me is the way we can continue to use typical `join` operations even with complex objects in some of the columns, which makes it so smooth and intuitive to do complex data operations.
