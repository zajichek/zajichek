...
- Integrates well with [R](https://www.r-project.org/), [Python](https://www.python.org/), and many other tools
  + _This_ presentation (and [website](https://www.centralstatz.com/presentations/the-value-of-open-source/) that it's contained in) are built in [Quarto](https://quarto.org/)
